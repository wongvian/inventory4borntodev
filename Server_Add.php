          ...
          <form id="myForm" action="#" method="post">
            ...
            <div class="col-12">
              <div class="form-group">       
                ...
                <img id="myImg" src="img/<?= @$img ?>" alt="Image" style="width:100%;max-width:800px"> 
                </a>
                <br>
            ...
            <div class="row">
              <div class="col-md-8">
                <div class="form-group">
                  <label for="txt_bk_url"><b>Backup Url    
                     <?php if($backup_url){ ?>
         
                  <a href="<?= $backup_url ?>" class="btn btn-info" target="_blank">Download</a>
            ...
            <?php
           if($_SESSION["permission_id"]=="1"){  // ตรวจสอบว่าเป็น ผู้ดูแลระบบหรือไม่
            if (@$id) {
            ?>
